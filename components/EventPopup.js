        ...
        <Dialog as="div" className="relative z-50" onClose={openModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-10 text-center">
              ...
              >
                <Dialog.Panel className="transform p-4 text-left align-middle transition-all max-w-4xl  lg:max-w-5xl xl:max-w-6xl w-full bg-[url('/assets/king2565/01_background.webp')] md:bg-[url('/assets/king2565/01_background.webp')] bg-no-repeat bg-cover bg-top h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-[75vh] relative flex justify-center items-center py-10 rounded-lg">
                  ...
                  <div className="w-full h-full relative max-w-xl md:max-w-7xl -mt-10 md:mt-0">
                    ...
                    <div className="w-full h-full relative grid grid-cols-1 grid-rows-3 lg:grid-cols-2 lg:grid-rows-1 gap-2 my-2 md:mt-0">
